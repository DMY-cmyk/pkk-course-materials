...
slide: 13
role: chart
title: "Comprehensive Income — Revenue vs Gains, Expenses vs Losses, OCI Waterfall"
learning_objective: "Audiens dapat membedakan Revenue dari Gains dan Expenses dari Losses per SFAC 6 dan menjelaskan mengapa pemisahan CI menjadi Net Income + OCI meningkatkan relevansi prediktif laporan INDF."
sources:
  - doc: fasb-conceptual-framework
    ref: "SFAC 6 — Revenue, Gains, Expenses, Losses, Comprehensive Income, OCI"
  - doc: indf-2024-ar
    ref: "INDF AR 2024 — Comprehensive Income waterfall, OCI components"
assigned_to: "TBD"
rubric: rubrics/slide-13.md
last_reviewed: 2026-04-27
-->

# Rubric — Slide 13: Comprehensive Income — Revenue vs Gains, Expenses vs Losses, OCI Waterfall
...
> **v5 audit finding:** Dua card grid kiri (Revenue vs Gains, Expenses vs Losses) masing-masing berisi 2 sub-card dengan definisi + contoh INDF; ditambah CI waterfall di kanan = estimasi >70 kata visible — Severity MED, Effort L, Fix: Pisahkan Revenue/Gains/OCI ke slide terpisah; atau fokus hanya pada CI waterfall.
...
> **v5 audit finding:** Lines 682–720: card "Pendapatan vs Keuntungan" menggunakan `font-size:21px` dan `font-size:19px` untuk subcards; CI waterfall menggunakan berbagai ukuran sub-40px — Severity HIGH, Effort XL, Fix: Per E4: Phase 4 redesign.
...
> **v5 audit finding:** Empat card dalam dua baris kiri + panel CI kanan = kepadatan tinggi; sub-card dalam card utama menambah kompleksitas visual — Severity MED, Effort M, Fix: Sederhanakan ke 2 konsep per slide.
...
> **v5 audit:** No violation found — confirm on rebuild. (Slide 13 bukan penutup.)
...
**Slide kasus INDF: YA (CI waterfall INDF) — F5 wajib.**

OCI waterfall INDF adalah prop numerik: ia memisahkan laba operasional dari komponen volatil (translasi mata uang, revaluasi aset biologis). Tanpa pemahaman perbedaan Revenue vs Gains, audiens tidak dapat menginterpretasikan mengapa OCI ada sebagai kategori terpisah.

- [ ] **Konteks/Ketegangan:** "Laba bersih INDF naik 14% di 2024 — tetapi
      berapa dari kenaikan itu berasal dari operasi bisnis inti, dan berapa
      dari fluktuasi nilai tukar atau revaluasi aset? OCI memisahkan keduanya."
- [ ] **Demonstrasi:** CI waterfall INDF disajikan dengan komponen OCI yang
      spesifik dan referensi INDF AR 2024; definisi Revenue vs Gains dan
      Expenses vs Losses per SFAC 6 ditampilkan secara komparatif.
- [ ] **Resolusi:** Interpretasi: pemisahan Net Income dari OCI meningkatkan
      Predictive Value (investor dapat mengevaluasi kinerja inti terpisah
      dari volatilitas non-operasional).
- [ ] **Per E3:** Waterfall chart tanpa konteks/ketegangan dan resolusi FASB
      = pelanggaran E3.
...
- [ ] **Salient idea:** APPLICABLE — CI dan OCI adalah manifestasi langsung
      dari prinsip "informasi berguna bagi pengambil keputusan."
- [ ] **Story:** APPLICABLE — slide 13 adalah node "elemen kinerja" dalam arc.
