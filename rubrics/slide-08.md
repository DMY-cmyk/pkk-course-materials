...
slide: 08
role: content
title: "Relevansi — Predictive Value, Confirmatory Value, Materiality (INDF EPS 2020–2024)"
learning_objective: "Audiens dapat menerapkan dua komponen Relevance (Predictive Value + Confirmatory Value) pada data EPS INDF 2020–2024 dan menjelaskan mengapa EPS berfluktuasi mencerminkan atau tidak mencerminkan relevansi prediktif."
sources:
  - doc: fasb-conceptual-framework
    ref: "SFAC 8 QC6–QC10 — Relevance, Predictive Value, Confirmatory Value, Materiality"
  - doc: indf-2024-ar
    ref: "INDF AR 2024 pp. 32–34 — EPS data 2020–2024"
assigned_to: "TBD"
rubric: rubrics/slide-08.md
last_reviewed: 2026-04-27
-->

# Rubric — Slide 08: Relevansi — Predictive Value, Confirmatory Value, Materiality
...
> **v5 audit finding:** Tiga card QC masing-masing berisi heading + deskripsi + box aplikasi INDF + bar chart EPS 5-tahun dengan label per bar = estimasi >80 kata visible — Severity MED, Effort L, Fix: Pisahkan chart EPS ke slide terpisah; pertahankan 3 card QC saja.
...
> **v5 audit finding:** Lines 430–481: tiga card QC + bar chart EPS menggunakan `font-size:21px` untuk body card, `font-size:20px` untuk bar labels, `font-size:19px` untuk teks INDF application — Severity HIGH, Effort XL, Fix: Per E4: Phase 4 redesign.
...
> **v5 audit finding:** Tiga card penuh baris atas + bar chart penuh lebar bawah = >85% frame terisi — Severity MED, Effort M, Fix: Pisahkan chart EPS; tambah whitespace antara cards.
...
> **v5 audit:** No violation found — confirm on rebuild. (Slide 08 bukan penutup.)
...
Slide 08 menggunakan data EPS INDF 2020–2024 sebagai prop untuk mendemonstrasikan Predictive Value dan Confirmatory Value. Per audit-deck-v5.md: "Slide 08 (QC Relevansi — EPS 5 tahun) menggunakan bar chart EPS 2020–2024 sebagai prop visual — ini adalah satu-satunya slide yang paling mendekati F5 secara formal."

- [ ] **Konteks/Ketegangan:** "EPS INDF berfluktuasi selama 5 tahun —
      apakah fluktuasi ini mencerminkan realitas ekonomi perusahaan yang
      berubah (Predictive Value) atau hanya noise akuntansi? Jawaban
      bergantung pada bagaimana Relevance diterapkan."
- [ ] **Demonstrasi:** Bar chart EPS 2020–2024 dengan data aktual dari INDF
      AR 2024 pp. 32–34; judul chart mengandung pertanyaan analitis, bukan
      sekadar "EPS INDF 5 Tahun."
- [ ] **Resolusi:** Satu kalimat interpretasi via QC: tren EPS memiliki
      Confirmatory Value (mengkonfirmasi tren laba bersih) dan Predictive
      Value terbatas karena siklisitas bisnis agrikultur — INDF mengungkapkan
      ini melalui segmented disclosure.
- [ ] **Per E3:** Chart EPS tanpa konteks/ketegangan dan resolusi FASB =
...
- [ ] **Salient idea:** APPLICABLE — Relevansi adalah komponen fundamental
      Salient Idea: informasi yang "berguna bagi pengambil keputusan."
- [ ] **Story:** APPLICABLE — slide 08 adalah node "demonstrasi Relevance
      dengan data INDF" dalam arc.
