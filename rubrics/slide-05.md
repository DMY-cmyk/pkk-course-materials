...
slide: 05
role: content
title: "Entitas Pelapor — SFAC 8 Ch. 2 (RE1–RE9)"
learning_objective: "Audiens dapat mendefinisikan 'entitas pelapor' menurut SFAC 8 RE1 dan mengidentifikasi tiga tipe entitas (publik, privat, konsolidasi) dengan contoh nyata dari struktur korporat INDF."
sources:
  - doc: fasb-conceptual-framework
    ref: "SFAC 8 Ch. 2, RE1–RE9 — definisi entitas pelapor"
  - doc: indf-2024-ar
    ref: "Struktur konsolidasi INDF — empat segmen, anak perusahaan"
assigned_to: "TBD"
rubric: rubrics/slide-05.md
last_reviewed: 2026-04-27
-->

# Rubric — Slide 05: Entitas Pelapor — SFAC 8 Ch. 2 (RE1–RE9)
...
> **v5 audit finding:** Kolom kiri: definisi RE1 + 3 jenis entitas + paragraf konsolidasi; kolom kanan: org chart + 4 subsidiary cards + 3 stat blocks = estimasi >90 kata visible — Severity HIGH, Effort L, Fix: Pisahkan definisi entitas pelapor (slide 05a) dari org chart INDF (slide 05b).
...
> **v5 audit finding:** Lines 298–327: semua teks card menggunakan `font-size:19px`; chart organisasi menggunakan `font-size:21px` untuk nama anak perusahaan dan `font-size:19px` untuk deskripsi; stats bawah menggunakan `font-size:19px` dan `font-size:20px` — semuanya sub-40px — Severity HIGH, Effort XL, Fix: Per E4: Phase 4 redesign.
...
> **v5 audit finding:** Dua kolom masing-masing sangat padat: kolom kiri 3 card bertumpuk, kolom kanan org chart + 4 cards + 3 stats mengisi hampir seluruh frame — Severity MED, Effort L, Fix: Pisahkan ke 2 slide dengan konten lebih sedikit per slide.
...
> **v5 audit:** No violation found — confirm on rebuild. (Slide 05 bukan penutup.)
...
Konsep "entitas pelapor" (reporting entity) adalah konsep sulit karena menentukan *batas* dari informasi keuangan: mengapa laporan INDF adalah laporan konsolidasi yang mencakup semua anak perusahaan, bukan hanya entitas induk? Batas ini tidak intuitif tanpa memahami RE1–RE9.

- [ ] **Konteks/Ketegangan:** Satu kalimat yang menimbulkan pertanyaan:
      "INDF menerbitkan satu laporan keuangan — tetapi entitas manakah
      yang sebenarnya 'dilaporkan'? Induk saja, atau seluruh grup?"
- [ ] **Demonstrasi:** Definisi RE1 disajikan dengan referensi paragraf;
      struktur konsolidasi INDF (CBP, Bogasari, Agribusiness, Distribution)
      ditampilkan sebagai ilustrasi konkret dengan sumber INDF AR 2024.
- [ ] **Resolusi:** Interpretasi eksplisit: INDF sebagai "consolidated reporting
      entity" per RE8–RE9 — implikasinya adalah bahwa semua angka dalam
      laporan keuangan INDF mencerminkan kinerja grup, bukan hanya induk.
- [ ] **Per E3:** Org chart tanpa konteks/ketegangan dan resolusi FASB =
      pelanggaran E3.
...
- [ ] **Salient idea:** APPLICABLE — entitas pelapor mendefinisikan scope informasi
      yang "berguna bagi pengambil keputusan" (Salient Idea deck).
- [ ] **Story:** APPLICABLE — slide 05 adalah node "konteks INDF" dalam arc.
