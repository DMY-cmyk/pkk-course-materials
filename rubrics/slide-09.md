...
slide: 09
role: content
title: "Representasi Tepat — SFAC 2 Reliability vs SFAC 8 Faithful Representation (BC3.27)"
learning_objective: "Audiens dapat menjelaskan perbedaan substantif antara Reliability (SFAC 2) dan Faithful Representation (SFAC 8) dengan menyebutkan tiga komponen baru FR dan mengapa penghapusan Conservatism (BC3.27) bukan melemahkan standar."
sources:
  - doc: fasb-conceptual-framework
    ref: "SFAC 8 QC12–QC16 — Faithful Representation; BC3.27 — penghapusan Conservatism"
  - doc: week-05-materials
    ref: "Week 5 Exercise — Reliability vs Faithful Representation"
assigned_to: "TBD"
rubric: rubrics/slide-09.md
last_reviewed: 2026-04-27
-->

# Rubric — Slide 09: Representasi Tepat — SFAC 2 Reliability vs SFAC 8 Faithful Representation
...
> **v5 audit finding:** Dua kolom SFAC 2 vs SFAC 8 masing-masing berisi: heading + definisi + 3 komponen boxes berlabel + catatan; ditambah bar merah BC3.27 di bawah = estimasi >80 kata visible — Severity MED, Effort L, Fix: Pisahkan ke: (a) SFAC 2 Reliability, (b) SFAC 8 Faithful Representation + Conservatism removal.
...
> **v5 audit finding:** Lines 496–531: perbandingan SFAC 2 vs SFAC 8 menggunakan `font-size:21px` untuk heading sub, `font-size:21px` untuk komponen boxes, `font-size:20px` untuk catatan konservatisme; arrow SVG di tengah membuat dua kolom sangat padat — Severity HIGH, Effort XL, Fix: Per E4: Phase 4 redesign.
...
> **v5 audit finding:** Dua panel besar + panel merah bawah = hampir seluruh frame penuh; arrow di tengah mengambil ruang tanpa memberikan breathing room — Severity MED, Effort M, Fix: Tambah padding; pindahkan BC3.27 ke catatan presenter.
...
> **v5 audit:** No violation found — confirm on rebuild. (Slide 09 bukan penutup.)
...
Faithful Representation adalah konsep sulit karena: (1) menggantikan Reliability yang sudah dikenal; (2) penghapusan Conservatism dari QC bertentangan dengan intuisi kehati-hatian akuntansi; (3) perbedaan antara Representational Faithfulness (SFAC 2) dan Faithful Representation (SFAC 8) tampak kosmetik tetapi substantif.

- [ ] **Konteks/Ketegangan:** "Jika SFAC 8 menghapus Conservatism dari
      hierarki QC, apakah ini berarti akuntan sekarang boleh overstate
      aset dan laba? Bagaimana FR berbeda secara substantif dari Reliability?"
- [ ] **Demonstrasi:** Perbandingan dua kolom SFAC 2 vs SFAC 8 dengan
      komponen eksplisit; BC3.27 disajikan sebagai referensi yang menjelaskan
      *mengapa* Conservatism dihapus (bukan keputusan ideologis tetapi
      konsekuensi logis dari Neutrality).
- [ ] **Resolusi:** Interpretasi: FR mensyaratkan Completeness, Neutrality,
      dan Free from Error — penghapusan Conservatism mempertegas Neutrality
      sebagai standar yang lebih ketat daripada bias ke arah kehati-hatian.
- [ ] **Per E3:** Perbandingan dua kolom tanpa konteks/ketegangan dan resolusi
      = E3.
...
- [ ] **Surprise:** APPLICABLE — penghapusan Conservatism dari QC adalah fakta
      kontra-intuitif yang dapat dieksploitasi sebagai mini-Surprise: "FASB
      tidak membutuhkan kehati-hatian sebagai QC karena Neutrality sudah
      mencakupnya — dan itu lebih ketat."
- [ ] **Salient idea:** APPLICABLE — FR adalah salah satu dari dua Fundamental
      QC yang menjadi standar tunggal "berguna."
- [ ] **Story:** APPLICABLE — slide 09 adalah node "teori FR" dalam arc.
