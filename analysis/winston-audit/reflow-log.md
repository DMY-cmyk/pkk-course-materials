...
| 13 | split-first | 3 (15/16/17) | E1 sub-card body 36px caption-tier (slides 15/16); waterfall amounts 48px h5-tier (slide 17 — F5 active INDF CI); OCI explainer dropped (redundant with pill labels); amber callout 32px caption-tier (slide 17, condensed for slack); lead phrases compressed for 1-line headers; F5 active (INDF CI Waterfall Rp13,08T NI / Rp531,4M OCI / Rp12,55T CI) | 2026-04-27T20:30 | (see git log slide-13-split) |
| 14 | (pending) | — | — | — | — |
| 15 | (pending) | — | — | — | — |
| 16 | (pending) | — | — | — | — |
| 17 | (pending) | — | — | — | — |
