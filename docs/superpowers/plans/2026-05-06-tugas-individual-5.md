# Tugas Individual 5 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build `ti5/output/01079_Dzaki Muhammad Yusfian_Tugas Individual 5.docx` — a 6-section academic essay arguing that SFAS 131's management approach constitutes a substantive improvement over SFAS 14's segment disclosure regime.

**Architecture:** Single Python script (`build_docx.py`) uses python-docx to compile all prose content directly into a formatted .docx. Identical helper function pattern as `ti4/output/build_docx.py`. No intermediate section files — content lives in the build script.

**Tech Stack:** Python 3.x, python-docx 1.2.0, Times New Roman 12pt, 18pt exact line spacing, 3cm margins.
...
| Action | Path |
|--------|------|
| Create | `ti5/output/build_docx.py` |
| Output | `ti5/output/01079_Dzaki Muhammad Yusfian_Tugas Individual 5.docx` |
| Create | `ti5/output/SUBMISSION-CHECKLIST.md` |

---

## Task 1: Write build_docx.py with complete essay content
...
Write `ti5/output/build_docx.py` with this exact content:
...
- [ ] **Step 2: Commit the build script**

```bash
git add ti5/output/build_docx.py
git commit -m "feat(ti5): add build_docx.py with complete essay content"
```

Expected: `[master xxxxxxx] feat(ti5): add build_docx.py with complete essay content`

---

## Task 2: Build and verify the .docx
...
```bash
cd "D:\DZAKI\S2\Sem. 1\Pelaporan Keuangan Korporat\ti5\output"
python build_docx.py
```

Expected output:
```
Saved: ...\ti5\output\01079_Dzaki Muhammad Yusfian_Tugas Individual 5.docx
Size:  XX,XXX bytes
```

The file size should be in the range 35,000–55,000 bytes. If it is 0 or < 10,000 bytes, something is wrong — re-read the error and check for Python exceptions.

- [ ] **Step 2: Verify file exists and size is reasonable**

```bash
dir "D:\DZAKI\S2\Sem. 1\Pelaporan Keuangan Korporat\ti5\output\*.docx"
```

Expected: One .docx file, size > 30,000 bytes.

- [ ] **Step 3: Commit the compiled .docx**

```bash
cd "D:\DZAKI\S2\Sem. 1\Pelaporan Keuangan Korporat"
git add "ti5/output/01079_Dzaki Muhammad Yusfian_Tugas Individual 5.docx"
git commit -m "feat(ti5): compile final Tugas Individual 5.docx"
```

---

## Task 3: Write SUBMISSION-CHECKLIST.md and final commit
...
Write `ti5/output/SUBMISSION-CHECKLIST.md` with this content:

```markdown
# Submission Checklist — Tugas Individual 5
Generated: 2026-05-06

## Filename
- [x] `01079_Dzaki Muhammad Yusfian_Tugas Individual 5.docx`

## Cover
- [x] "TUGAS INDIVIDU 5" — 16pt, bold, centered
- [x] "Pelaporan Keuangan Korporat" — 14pt, centered
- [x] Essay title — 14pt, bold, centered
- [x] "Disusun oleh:" — centered
- [x] "Dzaki Muhammad Yusfian" — bold, centered
- [x] "1225 01079" — centered
- [x] "Dosen Pengampu: Prof. Djoko Susanto" — centered
- [x] "Program Studi Magister Akuntansi" — centered
- [x] "Mei 2026" — bold, centered

## Format
- [x] Times New Roman throughout
- [x] 12pt body, 13pt section heads
- [x] 18pt exact line spacing
- [x] Justified body paragraphs
- [x] 3cm all margins
- [x] No header, no footer

## Content
- [x] Section I: Pendahuluan — informative disclosure framing, three-part thesis
- [x] Section II: SFAS 14 — three weaknesses (flexibility, single-segment gaming, internal-external disconnect)
- [x] Section III: SFAS 131 — three innovations (CODM, internal-external alignment, finite uniformity thresholds)
- [x] Section IV: Bukti Empiris — Street/Nichols/Gray (2000), predictive validity, Herrmann/Thomas caveat + resolution
- [x] Section V: ICBP/PSAK 5 — lineage SFAS 131→IFRS 8→PSAK 5, 6 segments illustration, Pinehill aggregation limitation
- [x] Section VI: Kesimpulan — three synthesis moves, no new arguments

## Citations
- [x] 8 Daftar Pustaka entries with hanging indent and correct italics
- [x] All in-text (Author, Year) references resolve to bibliography
- [x] Wolk Ch. 9 page numbers cited where specific claims made (hal. 247, 257, 260)
- [x] FASB (1976) and FASB (1997) cited for the standards themselves
- [x] No fabricated data

## Academic Quality
- [x] Three-weakness / three-innovation parallel structure (II and III mirror each other)
- [x] Herrmann & Thomas caveat named and resolved (not just cited affirmatively)
- [x] ICBP/PSAK 5 illustrates both the improvement AND the limitation
- [x] Wolk finite uniformity framework applied to explain SFAS 131's design logic
- [x] Lineage SFAS 131 → IFRS 8 → PSAK 5 explicitly stated

## Submission
- [ ] Ready to upload to Google Classroom — PKK 706 (2026), Prof. Djoko Susanto
- [ ] Deadline: 2026-05-19, 23:59 WIB
```

- [ ] **Step 2: Commit checklist and close out**

```bash
cd "D:\DZAKI\S2\Sem. 1\Pelaporan Keuangan Korporat"
git add "ti5/output/SUBMISSION-CHECKLIST.md" "docs/superpowers/plans/2026-05-06-tugas-individual-5.md"
git commit -m "docs(ti5): add submission checklist and implementation plan"
```
...
**Spec coverage:**
- Section I (informative disclosure framing, thesis) → Task 1 Section I ✓
- Section II (3 weaknesses) → Task 1 Section II ✓
- Section III (3 innovations, CODM, finite uniformity) → Task 1 Section III ✓
- Section IV (Street/Nichols/Gray, predictive validity, Herrmann/Thomas caveat + resolution) → Task 1 Section IV ✓
- Section V (PSAK 5 lineage, ICBP 6 segments, Pinehill loophole) → Task 1 Section V ✓
- Section VI (3 synthesis moves) → Task 1 Section VI ✓
- 8 Daftar Pustaka entries (FASB 1976, FASB 1997, Herrmann/Thomas, IAI PSAK 5, ICBP AR, Scott, Street/Nichols/Gray, Wolk) → Task 1 Daftar Pustaka ✓
- Format (TNR 12pt, 18pt, 3cm, justified) → page setup + helper functions ✓
- Cover page → Task 1 cover section ✓
- SUBMISSION-CHECKLIST.md → Task 3 ✓

**Placeholder scan:** No TBDs, TODOs, or "similar to above" references. Every step has exact code or commands. ✓

**Type consistency:** All calls use `add_body_para(doc, '...')`, `add_section_heading(doc, text, prefix)`, `add_daftar_pustaka_entry(doc, [...])` — consistent with helper definitions at top of file. ✓
